...
ubx.load_module(ni, "std_blocks/random_ubx/random_ubx.so")
...
print("creating instance of 'random_ubx/random_ubx'")
random_ubx1=ubx.block_create(ni, "random_ubx/random_ubx", "random_ubx1", {min_max_config={min=32, max=127}})
...
logger_conf=[[
{
   { blockname='random_ubx1', portname="rnd", buff_len=1, },
...
ptrig1=ubx.block_create(ni, "std_triggers/ptrig", "ptrig1",
			{
			   ...
			   trig_blocks={ { b=random_ubx1, num_steps=1, measure=0 },
...
print("running random_ubx1 init", ubx.block_init(random_ubx1))
...
print("running random_ubx1 unload", ubx.block_unload(ni, "random_ubx1"))
